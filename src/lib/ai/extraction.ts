 ...
 */
/**
 * Grade tokens the model is allowed to return.
 *
 * Exported so a test can hold this list and the curriculum corpus to each
 * other: a programme absent here can never be assigned, and a token here that
 * no programme uses produces references that resolve to nothing.
 */
export const CURRICULUM_PROMPT_GRADE_TOKENS = [
  '1', '2', '3', '4', '5', '6', '7', '8', '9',
  '1год', '2год-2026', '3год', '4год',
  '1год-миг', '2год-миг', '3год-миг', '4год-миг',
  '1год-струк', '2год-струк', '3год-струк', '4год-струк',
  '1год-струк3', '2год-струк3', '3год-струк3',
  '1год-струк2', '2год-струк2',
  '2год-изб-еалг', '2год-изб-еалгео', '3год-изб-алг', '3год-изб-лааг', '4год-изб-манал',
] as const;
...
- ЗАДОЛЖИТЕЛНО: Во \`grade_level\` врати ТОЧНО еден од следните валидни токени (без друг текст):
  ...
  • Општа гимназија: '1год', '2год-2026', '3год', '4год'
  • Математичко-информатичка гимназија: '1год-миг', '2год-миг', '3год-миг', '4год-миг'
  • Средно стручно 4-годишно: '1год-струк', '2год-струк', '3год-струк', '4год-струк'
  • Средно стручно 3-годишно: '1год-струк3', '2год-струк3', '3год-струк3'
  • Средно стручно 2-годишно: '1год-струк2', '2год-струк2'
  • Гимназиски изборни: '2год-изб-еалг', '2год-изб-еалгео', '3год-изб-алг', '3год-изб-лааг', '4год-изб-манал'
