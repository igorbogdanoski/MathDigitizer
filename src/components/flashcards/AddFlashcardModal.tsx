    ...
    >
      ...
      >
        <div className="p-6 sm:p-8 border-b border-slate-100 dark:border-slate-700 flex justify-between items-center bg-slate-50/50 dark:bg-slate-900/20">
          ...
          <button type="button" onClick={onClose} aria-label="Затвори" title="Затвори" className="p-2 text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 rounded-full bg-white dark:bg-slate-800 shadow-sm">
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="p-6 sm:p-8 border-t border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 flex justify-end gap-3">
          <Button variant="ghost" onClick={onClose} className="rounded-xl font-medium">Откажи</Button>
          <Button
            onClick={onSave}
